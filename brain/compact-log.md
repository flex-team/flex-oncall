...
| 날짜 | 티켓 | 기준 | 흡수된 신호 | 사유 |
| 2026-04-14 | CI-4351, CI-4375 | ops-compact | 농축 보강 2건(중복 항목 제거 + d:kw/d:syn 보강), 퇴출 0건, COOKBOOK 강등 0건, 승격 0건 | Step 2: CI-4351/CI-4375 이미 d:st "C"이나 오래된 investigating 중복 항목 잔존 → retired 처리. :fins d:kw 5개(excludeResignedUser/assigneeStakeholders/toResolvedStakeholderFilter/카드담당자/증빙퇴사자) + d:syn 2개 추가. CI-4375 노트 details 블록 2개 축약 정제. d:ca 2026-04-14 갱신. Step 3: R2 대상 0건(최고령 d:ca 2026-03-24, 21일). Step 4: 히트 0 플로우(F-pay-2 추가 2026-03-30/F7 2026-04-03/F5 2026-04-03) 모두 60일 미경과. Tier-2→Tier-1 승격 후보 없음. Step 6: 신선도 검증 생략(서브모듈 미초기화) |
